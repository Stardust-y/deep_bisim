...
def parse_args():
    ...
    parser.add_argument("-action_range", nargs='+', type=int, help=" ", default=[0, np.inf])    # 如果不输入的话就是np.inf

    parser.add_argument("-reward_range", nargs='+', type=int, help=" ", default=[0, np.inf])    
